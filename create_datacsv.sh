<<<<<<< HEAD
#!/bin/sh 
echo name,star,element,job,comment,solo_dps,total_dps > www/$1/data.csv
...
python adv/addis.py -2      $1 |& tee -a www/$1/data.csv
...
python adv/ieyasu.py -2     $1 |& tee -a www/$1/data.csv
...
python adv/sinoa.py -2      $1 |& tee -a www/$1/data.csv
python adv/xania.py -2      $1 |& tee -a www/$1/data.csv
python adv/d_cleo.py -2     $1 |& tee -a www/$1/data.csv
python adv/ezelith.py -2    $1 |& tee -a www/$1/data.csv
...
python adv/sazanka.py -2    $1 |& tee -a www/$1/data.csv
...
python adv/botan.py -2      $1 |& tee -a www/$1/data.csv
...
python adv/marty.py -2      $1 | tee -a www/$1/data.csv
python adv/fritz.py -2      $1 | tee -a www/$1/data.csv
>>>>>>> 4fceb8d653b808284797b7a35c03d7fb6dace7c0
